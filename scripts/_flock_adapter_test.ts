...
function session(participants: Participant[], waypoints: FlockWaypoint[], extra: Partial<FlockSession> = {}): FlockSession {
  return { id: "t", createdAt: "", updatedAt: "", locks: { run: false, route: false, runners: false }, runnerLocks: {}, unitPreference: "km", startAnchor: { kind: "auto" }, intendedDistanceKm: null, name: null, participants, waypoints, computedRoutes: null, sharedSegments: null, flockRoute: null, waypointEtas: null, routeWarnings: null, gpxPassthrough: null, ...extra };
}
