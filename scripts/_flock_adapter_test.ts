...
function session(participants: Participant[], waypoints: FlockWaypoint[], extra: Partial<FlockSession> = {}): FlockSession {
  return { id: "t", createdAt: "", updatedAt: "", lockedAt: null, unitPreference: "km", startAnchor: { kind: "auto" }, intendedDistanceKm: null, participants, waypoints, computedRoutes: null, sharedSegments: null, flockRoute: null, waypointEtas: null, gpxPassthrough: null, ...extra };
}
